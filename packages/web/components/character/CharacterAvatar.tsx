...
export const JOB_AVATAR_OFFSET: Partial<Record<JobId, { x: number; y: number }>> =
  {
    ...
    "41f1cdc2ff58bb5fdc287be0db2a8df3": { x: 0, y: 5 }, // 귀검사(남)
    "17e417b31686389eebff6d754c3401ea": { x: 0, y: 5 }, // 다크나이트

    "a7a059ebe9e6054c0644b40ef316d6e9": { x: 0.2, y: 1.5 }, // 격투가(여)
    "afdf3b989339de478e85b614d274d1ef": { x: 0.5, y: 9 }, // 거너(남)

    "3909d0b188e9c95311399f776e331da5": { x: 0.4, y: -1.8 }, // 마법사(여)
    "b522a95d819a5559b775deb9a490e49a": { x: 0.4, y: -1.8 }, // 크리에이터

    "f6a4ad30555b99b499c07835f87ce522": { x: 0, y: 8 }, // 프리스트(남)
    "944b9aab492c15a8474f96947ceeb9e4": { x: 0.3, y: 6 }, // 거너(여)
    "ddc49e9ad1ff72a00b53c6cff5b1e920": { x: 0.3, y: 5 }, // 도적
    "ca0f0e0e9e1d55b5f9955b03d9dd213c": { x: 0.8, y: 5 }, // 격투가(남)
    "a5ccbaf5538981c6ef99b236c0a60b73": { x: 0.5, y: 1 }, // 마법사(남)
    
    "b9cb48777665de22c006fabaf9a560b3": { x: 1.5, y: 0 }, // 아처  
    "1645c45aabb008c98406b3a16447040d": { x: 0.4, y: 3 }, // 귀검사(여)  
    "0ee8fa5dc525c1a1f23fc6911e921e4a": { x: 0.5, y: 0 }, // 나이트
    "3deb7be5f01953ac8b1ecaa1e25e0420": { x: 1, y: 6 }, // 마창사
    "0c1b401bb09241570d364420b3ba3fd7": { x: 0.5, y: 3.5 }, // 프리스트(여)
    "986c2b3d72ee0e4a0b7fcfbe786d4e02": { x: 0, y: 6.5 }, // 총검사
    "8d4d2001cdb357e41633c234eb7501b5": { x: 0.5, y: 3.5 }, // 제국기사
  };
  ...
  return (
    ...
    >
      ...
      <img
        src={src}
        alt=""
        className="h-full w-full object-cover scale-500"
